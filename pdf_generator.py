...
INSTRUMENT_ACCESSORIES = {
    ...
    "Flute":                                ["Case", "Cleaning Rod", "Cleaning Cloth", "Head Joint Cork"],
    "Flute - Other":                        ["Case", "Cleaning Rod", "Cleaning Cloth"],
    "Oboe":                                 ["Case", "Reed(s)", "Reed Case", "Cleaning Swab"],
    "Bassoon":                              ["Case Bag", "Bow", "Gooseneck/Bocal", "Mouthpiece", "Ligature", "Neck/Seat Strap"],
    "Clarinet - Bb":                        ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Barrel", "Cleaning Swab"],
    "Clarinet - Bb Bass":                   ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Neck Strap", "Cleaning Swab"],
    "Clarinet - Eb Alto":                   ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Barrel", "Cleaning Swab"],
    "Saxophone - Eb Alto":                  ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Neck Strap", "Neck"],
    "Saxophone - Bb Tenor":                 ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Neck Strap", "Neck"],
    "Saxophone - Eb Baritone":              ["Case", "Mouthpiece", "Ligature", "Reed(s)", "Seat Strap", "Neck"],
    "Trumpet - Bb":                         ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    "Trombone":                             ["Case", "Mouthpiece", "Slide Oil", "Cleaning Rod"],
    "Trombone - Bass":                      ["Case", "Mouthpiece", "Slide Oil", "Cleaning Rod"],
    "Trombone - Tenor (w/ F trigger)":      ["Case", "Mouthpiece", "Slide Oil", "Cleaning Rod"],
    "Baritone":                             ["Case", "Mouthpiece", "Valve Oil"],
    "Baritone - 3-valve":                   ["Case", "Mouthpiece", "Valve Oil"],
    "Baritone - 4-valve":                   ["Case", "Mouthpiece", "Valve Oil"],
    "French Horn - Single in F":            ["Case", "Mouthpiece", "Valve Oil", "Cleaning Kit"],
    "French Horn - Single in Bb":           ["Case", "Mouthpiece", "Valve Oil", "Cleaning Kit"],
    "French Horn - Double":                 ["Case", "Mouthpiece", "Valve Oil", "Cleaning Kit"],
    "Tuba":                                 ["Case", "Mouthpiece", "Valve Oil"],
    ...
    "Auxiliary Percussion - Other":         ["Cover/Case", "Sticks/Mallets"],
    "Cymbals - Hi-Hat":                     ["Case/Bag", "Stand"],
    "Guitar - Acoustic":                    ["Case", "Strap", "Cable"],
