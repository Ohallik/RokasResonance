...
INSTRUMENT_ACCESSORIES = {
    ...
    "Flute - Alto":                         ["Case", "Cleaning Rod", "Cleaning Cloth"],
    "Flute - Bass":                         ["Case", "Cleaning Rod", "Cleaning Cloth"],
    "Flute - Other":                        ["Case", "Cleaning Rod", "Cleaning Cloth"],
    "Oboe":                                 ["Case", "Cleaning Swab"],
    "English Horn":                         ["Case", "Bocal", "Cleaning Swab"],
    "Bassoon":                              ["Case", "Bocal", "Seat Strap", "Reed Case", "Swab"],
    "Contrabassoon":                        ["Case", "Bocal", "Seat Strap", "Reed Case", "Swab"],
    "Clarinet - Eb":                        ["Case", "Mouthpiece", "Ligature", "Cleaning Swab"],
    ...
    "Clarinet - Contrabass":                ["Case", "Mouthpiece", "Ligature", "Gooseneck", "Neck Strap", "Cleaning Swab"],
    "Saxophone - Soprano":                  ["Case", "Mouthpiece", "Ligature", "Neck Strap", "Swab"],
    ...
    "Recorder":                             ["Case/Bag", "Cleaning Rod"],
    "Trumpet - Bb":                         ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    "Cornet":                               ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    "Flugelhorn":                           ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    "Mellophone":                           ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    ...
    "Euphonium":                            ["Case", "Mouthpiece", "Valve Oil", "Slide Grease"],
    ...
    "Sousaphone":                           ["Case", "Mouthpiece", "Valve Oil", "Slide Grease", "Bits"],
    "Snare Drum - Concert":                 ["Case/Bag", "Sticks/Mallets", "Stand"],
    "Snare Drum - Drum Set":                ["Case/Bag", "Sticks/Mallets", "Stand", "Practice Pad"],
    "Drum Set":                             ["Throne", "Kick Pedal", "Hi-Hat Stand", "Cymbal Stand(s)", "Sticks"],
    ...
    "Miscellaneous Drum - Cajon":           ["Cover/Case"],
    ...
    "Marimba - 5 Octave":                   ["Cover", "Mallets", "Stand"],
    ...
    "Cymbals - Crash (pair)":               ["Case/Bag", "Straps/Pads"],
    "Cymbals - Suspended":                  ["Case/Bag", "Stand", "Mallets"],
    "Cymbals - Ride":                       ["Case/Bag", "Stand"],
    "Stick bag + sticks/mallets":           ["Stick bag", "Snare Sticks", "Yarn Mallets", "Rubber/Plastic Mallets", "Timpani Mallets"],
    "Guitar - Acoustic":                    ["Case", "Strap"],
    "Guitar - Electric":                    ["Case", "Strap", "Cable"],
    "Bass Guitar - Electric":               ["Case", "Strap", "Cable"],
    "Ukulele":                              ["Case/Bag"],
    "Piano":                                ["Bench", "Cover"],
    "Keyboard - Electric":                  ["Power Adapter", "Sustain Pedal", "Stand", "Cover"],
    "Guitar Amp":                           ["Power Cable", "Instrument Cable"],
    "Bass Amp":                             ["Power Cable", "Instrument Cable"],
    "Keyboard Amp":                         ["Power Cable", "Instrument Cable"],
    "Microphone":                           ["Case/Bag", "Cable", "Clip"],
    "Mixer":                                ["Power Adapter", "Cable(s)"],
    "Speaker / PA":                         ["Power Cable", "Cable(s)", "Stand"],
    "Audio Recorder":                       ["Case/Bag", "Power Adapter", "Memory Card"],
    "Electric Drum Set":                    ["Power Adapter", "Cable(s)", "Sticks", "Throne"],
    "Tuner":                                ["Case/Bag", "Clip"],
    "Metronome":                            ["Case/Bag"],
